...
**
** Created: Sat Jun 11 01:25:41 2011
...
public:
    ...
    void setupUi(QDockWidget *PositionObjectsPanel)
    {
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 214, 324));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 214, 324));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 214, 324));
