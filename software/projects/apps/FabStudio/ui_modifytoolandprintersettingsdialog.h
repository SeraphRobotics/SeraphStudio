...
public:
    ...
    void setupUi(QDialog *ModifyToolAndPrinterSettingsDialog)
    {
        ...
        ModifyToolAndPrinterSettingsDialog->resize(454, 618);
        QIcon icon;
        ...
        pushButton = new QPushButton(ModifyToolAndPrinterSettingsDialog);
        ...
        QObject::connect(pushButton, SIGNAL(clicked()), ModifyToolAndPrinterSettingsDialog, SLOT(accept()));
    ...
    void retranslateUi(QDialog *ModifyToolAndPrinterSettingsDialog)
    {
        ...
        pushButton->setText(QApplication::translate("ModifyToolAndPrinterSettingsDialog", "Ok", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
