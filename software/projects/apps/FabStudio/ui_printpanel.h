...
"Be sure to have extra supplies on hand if you are printing a large model.  This script will automatically support the object you are printing so it won't fall over, even if it has overhangs.", 0, QApplication::UnicodeUTF8));
        ...
        modifyPrintSettings->setDescription(QApplication::translate("PrintPanel", "Edit the parameter values used by the print script, choose alternate planning algorithms, or give SeraphStudio hints about how to create your print job.", 0, QApplication::UnicodeUTF8));
